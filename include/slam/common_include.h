// common_include.h
// This file consolidates frequently used libraries, types, and definitions across the SLAM system.
...
// These help reduce verbosity when dealing with fixed-size or dynamic matrices and vectors

// Dynamic and fixed-size double matrices
...
// === Sophus Library ===
// For representing 3D transformations (used in SLAM to handle SE(3) and SO(3))
#include <sophus/se3.hpp>
#include <sophus/so3.hpp>

typedef Sophus::SE3d SE3;  // SE(3) Lie group - rotation + translation
typedef Sophus::SO3d SO3;  // SO(3) Lie group - rotation only

// === OpenCV Headers ===
// For matrix and image processing
#include <opencv2/core/core.hpp>
using cv::Mat;

// === Google Logging Library ===
#include <glog/logging.h>  // For logging and debugging
